...
async function hashPassword() {
  const password = "abc"; // Replace with your password
...
async function comparePassword() {
  const inputPassword = "abc"; // Replace with the password you want to compare
  const hashedPassword =
    "$2b$10$xKJ9lZewTVyVH6U3xi4lDuRfQe.6GkEm80hWXKSo4zgRiCWyvzQM2"; // Replace with the hashed password stored in your application
